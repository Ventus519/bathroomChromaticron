...
sinkImg = pygame.image.load('assets/images/Bathroom/bathroomSink.png').convert()
...
fog = pygame.image.load('assets/images/Bathroom/FoggedMirror.png')
...
Bathrooombg = pygame.image.load("assets/images/Bathroom/Bathroombg.png").convert()
...
BathroomScreen = imageScaling(0, 0, Bathrooombg, 2.5)
BathroomMirrorScreen = imageScaling(0, 0, BathroomMirror, 0.75)
sinkScreen = imageScaling(0, 0, sinkImg, 1.25)
  ...
  for event in pygame.event.get():
    ...
    if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
      ...
      if BathroomArea == False and bathroom == True:
        ...
        pygame.display.update()
        if BathroomMirrorRect.collidepoint(x, y) and faucet == False and sink == False:
      ...
      if rightArrowRect.collidepoint(x, y) and menuOpen == False and zoomIn == False and inventoryOpen == False and bathroom == False and sink == False and mirror == False: 
      ...
      if imageIndex == 0 and startClicked == True:
        ...
        if shelfOne.collidepoint(x, y) and inventoryOpen == False and zoomIn == False and menuOpen == False and bathroom == False and sink == False and mirror == False:
